...
curl -sSL https://raw.githubusercontent.com/YeTianXingShi/sub2api/develop/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/YeTianXingShi/sub2api/releases)
