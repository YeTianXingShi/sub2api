...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/yetianxingshi/sub2api:stable
...
SUB2API_IMAGE=ghcr.io/yetianxingshi/sub2api:stable # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
