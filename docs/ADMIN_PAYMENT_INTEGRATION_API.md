...
### 6) `doc_url` 配置建议
- 查看链接：`https://github.com/YeTianXingShi/sub2api/blob/develop/ADMIN_PAYMENT_INTEGRATION_API.md`
- 下载链接：`https://raw.githubusercontent.com/YeTianXingShi/sub2api/develop/ADMIN_PAYMENT_INTEGRATION_API.md`
...
- View URL: `https://github.com/YeTianXingShi/sub2api/blob/develop/ADMIN_PAYMENT_INTEGRATION_API.md`
- Download URL: `https://raw.githubusercontent.com/YeTianXingShi/sub2api/develop/ADMIN_PAYMENT_INTEGRATION_API.md`
