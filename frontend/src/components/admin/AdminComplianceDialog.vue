...
const documentUrl = computed(() => {
  if (getLocale() === 'zh') {
    return complianceStore.status?.document_url_zh || 'https://github.com/YeTianXingShi/sub2api/blob/develop/docs/legal/admin-compliance.zh.md'
  }
  return complianceStore.status?.document_url_en || 'https://github.com/YeTianXingShi/sub2api/blob/develop/docs/legal/admin-compliance.en.md'
})
